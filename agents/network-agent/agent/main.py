from agent_config.context import NetworkContext
...
async def invoke(payload, context):
    if not NetworkContext.get_response_queue_ctx():
        NetworkContext.set_response_queue_ctx(StreamingQueue())

    if not NetworkContext.get_gateway_token_ctx():
        NetworkContext.set_gateway_token_ctx(await get_gateway_access_token())
