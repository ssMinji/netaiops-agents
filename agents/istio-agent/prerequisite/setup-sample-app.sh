...
SAMPLE_DIR="${SCRIPT_DIR}/../../../sample-workloads"
...
kubectl apply -f ${SAMPLE_DIR}/istio-sample/bookinfo.yaml
...
kubectl apply -f ${SAMPLE_DIR}/istio-sample/bookinfo-gateway.yaml
kubectl apply -f ${SAMPLE_DIR}/istio-sample/destination-rules.yaml
kubectl apply -f ${SAMPLE_DIR}/istio-sample/virtual-services.yaml
kubectl apply -f ${SAMPLE_DIR}/istio-sample/peer-authentication.yaml
...
echo "  kubectl apply -f ${SAMPLE_DIR}/istio-sample/fault-injection/fault-delay-reviews.yaml"
echo "  kubectl apply -f ${SAMPLE_DIR}/istio-sample/fault-injection/fault-abort-ratings.yaml"
echo "  kubectl apply -f ${SAMPLE_DIR}/istio-sample/fault-injection/circuit-breaker.yaml"
echo ""
