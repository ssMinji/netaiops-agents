...
### Step 6: Response Guide (대응 가이드)
- Post remediation guide as a GitHub Issue comment
- Include specific kubectl commands or configuration changes to resolve the issue
- If the issue is resolved, add a final comment and close the issue
