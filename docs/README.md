...
1. [Architecture](architecture/README.md) - Understand the system design
2. [Agents](agents/README.md) - Learn about each AI agent
3. [Deployment](deployment/README.md) - Deploy the platform
4. [Frontend](frontend/README.md) - Web UI features
5. [Backend](backend/README.md) - API reference
6. [Troubleshooting](troubleshooting/README.md) - Common issues and fixes
