...
export interface Module5GatewayStackProps {
...
/**
 * Module 5 Gateway - mcpServer target pointing to EKS MCP Server Runtime.
 *
 ...
 */
export class Module5GatewayStack extends Construct {
  public readonly gateway: McpGateway;

  constructor(scope: Construct, id: string, props: Module5GatewayStackProps) {
    super(scope, id);
