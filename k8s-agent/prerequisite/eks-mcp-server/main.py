...
def main():
    # Override AgentCore's default region (us-east-1) with us-west-2 where the EKS cluster lives.
    ...
    target_region = os.environ.get("EKS_MCP_DEFAULT_REGION", "us-west-2")
    ...
    def list_eks_clusters(region: str = "us-west-2") -> str:
        ...
        Args:
            region: AWS region code. Defaults to us-west-2 (Oregon).
        """
        from awslabs.eks_mcp_server.aws_helper import AwsHelper
        from awslabs.eks_mcp_server.k8s_client_cache import K8sClientCache
